...
public class NotificationService {
    ...
    public Notification publishNotification(Notification notification) {
        ...
        List<UUID> recipientIds = userRepository.findIdByDonViId(notification.getRecipientUnitId());
    ...
    public List<Notification_User> getInbox(UUID userId) {
        return notificationUserRepository.findByUserIdAndReadFalseOrderByCreatedAtDesc(userId);
